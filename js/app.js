...
(function () {
    ...
    return Promise.all([
      ...
      map.on('click', PROJECT_LAYER_ID, (event) => {
        ...
        if (project) {
          ...
          closeProjectPopup();
          activeProjectPopup = new mapboxgl.Popup({ closeButton: false, closeOnClick: false, offset: [0, -24] })
  ...
  function focusArchitectureProject(project) {
    ...
    map.flyTo({ center: toLngLat(project.coords), zoom, duration: 1800 });
  ...
  function toProjects() {
    map.flyTo({ center: toLngLat(PROJECT_CENTER), zoom: PROJECT_ZOOM, duration: 2000 });
    showProjectMarkers();
    removeArchitectureMarkers();
    closeProjectPanel();
    showProjectIntro();
  ...
  function toPublications() {
    ...
    map.flyTo({ center: toLngLat(PUBLICATION_CENTER), zoom: PUBLICATION_ZOOM, duration: 2200 });
  }
  ...
  function toArchitecture() {
    ...
    map.flyTo({ center: toLngLat(ARCHITECTURE_CENTER), zoom: ARCHITECTURE_ZOOM, duration: 2200 });
  }
